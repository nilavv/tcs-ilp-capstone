...
@Component({
  selector: 'app-women-items',
  templateUrl: './women-items.component.html',
  styleUrls: ['./women-items.component.css']
})
export class WomenItemsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.talkWithDbService.getAllItems().subscribe((data)=>{
      ...
      {
        if(this.temp[i]['itemCategory']=="women")
        {
